...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TopicComment'
        db.create_table(u'topics_topiccomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('content', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ...
            ('parent_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topics.TopicComment'], null=True, blank=True)),
        ))
        db.send_create_signal(u'topics', ['TopicComment'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TopicComment'
        db.delete_table(u'topics_topiccomment')
    ...
    models = {
        ...
        u'topics.topiccomment': {
            'Meta': {'object_name': 'TopicComment'},
            'content': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"}),
            'parent_comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['topics.TopicComment']", 'null': 'True', 'blank': 'True'}),
