...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topic.comment_num'
        db.add_column(u'topics_topic', 'comment_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topic.comment_num'
        db.delete_column(u'topics_topic', 'comment_num')
    ...
    models = {
        ...
        u'topics.topic': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"}),
            'topic_type': ('django.db.models.fields.CharField', [], {'default': "'D'", 'max_length': '1'})
        },
