...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaFrame.view_count'
        db.add_column(u'mediaframes_mediaframe', 'view_count',
                      self.gf('django.db.models.fields.FloatField')(default=0.9885674635280794, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaFrame.view_count'
        db.delete_column(u'mediaframes_mediaframe', 'view_count')
    ...
    models = {
        ...
        u'mediaframes.mediaframe': {
            ...
            'view_count': ('django.db.models.fields.FloatField', [], {'default': '0.7318781258243225', 'blank': 'True'})
        },
        u'users.tinguser': {
