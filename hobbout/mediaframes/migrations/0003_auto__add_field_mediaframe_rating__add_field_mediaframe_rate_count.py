...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaFrame.rating'
        db.add_column(u'mediaframes_mediaframe', 'rating',
                      self.gf('django.db.models.fields.FloatField')(default=5.0, blank=True),
                      keep_default=False)

        # Adding field 'MediaFrame.rate_count'
        db.add_column(u'mediaframes_mediaframe', 'rate_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaFrame.rating'
        db.delete_column(u'mediaframes_mediaframe', 'rating')

        # Deleting field 'MediaFrame.rate_count'
        db.delete_column(u'mediaframes_mediaframe', 'rate_count')
    ...
    models = {
        ...
        u'mediaframes.mediaframe': {
            ...
            'view_count': ('django.db.models.fields.FloatField', [], {'default': '0.6324093415164803', 'blank': 'True'})
        },
        u'users.tinguser': {
