...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MediaFrame.album'
        db.delete_column(u'mediaframes_mediaframe', 'album_id')


    def backwards(self, orm):
        # Adding field 'MediaFrame.album'
        db.add_column(u'mediaframes_mediaframe', 'album',
    ...
    models = {
        ...
        u'mediaframes.mediaframe': {
            ...
            'view_count': ('django.db.models.fields.FloatField', [], {'default': '0.8261619393007428', 'blank': 'True'})
        },
        u'users.tinguser': {
