...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.avatar'
        db.add_column(u'groups_group', 'avatar',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaImage'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'UserGroupBridge', fields ['group', 'user']
        db.create_unique(u'groups_usergroupbridge', ['group_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserGroupBridge', fields ['group', 'user']
        db.delete_unique(u'groups_usergroupbridge', ['group_id', 'user_id'])

        # Deleting field 'Group.avatar'
        db.delete_column(u'groups_group', 'avatar_id')
    ...
    models = {
        ...
        u'groups.usergroupbridge': {
            'Meta': {'unique_together': "(('user', 'group'),)", 'object_name': 'UserGroupBridge'},
            ...
            'post_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'role': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"})
        },
        u'locations.area': {
