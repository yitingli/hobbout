...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'groups_group', (
            ...
            ('brief_description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ...
        # Adding model 'UserGroupBridge'
        db.create_table(u'groups_usergroupbridge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TingUser'])),
            ...
            ('role', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('post_num', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal(u'groups', ['UserGroupBridge'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserGroupBridge'
        db.delete_table(u'groups_usergroupbridge')
    ...
    models = {
        ...
        u'groups.usergroupbridge': {
            'Meta': {'object_name': 'UserGroupBridge'},
