...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Group.name'
        db.alter_column(u'groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
