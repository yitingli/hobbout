...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserActivityBridge', fields ['user', 'activity']
        db.create_unique(u'activities_useractivitybridge', ['user_id', 'activity_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserActivityBridge', fields ['user', 'activity']
        db.delete_unique(u'activities_useractivitybridge', ['user_id', 'activity_id'])
    ...
    models = {
        ...
        u'activities.useractivitybridge': {
            'Meta': {'unique_together': "(('user', 'activity'),)", 'object_name': 'UserActivityBridge'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.Activity']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
