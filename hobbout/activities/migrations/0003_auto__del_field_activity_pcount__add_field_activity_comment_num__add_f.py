...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Activity.pcount'
        db.delete_column(u'activities_activity', 'pcount')

        # Adding field 'Activity.comment_num'
        db.add_column(u'activities_activity', 'comment_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Activity.p_num'
        db.add_column(u'activities_activity', 'p_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Activity.pcount'
        db.add_column(u'activities_activity', 'pcount',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'Activity.comment_num'
        db.delete_column(u'activities_activity', 'comment_num')

        # Deleting field 'Activity.p_num'
        db.delete_column(u'activities_activity', 'p_num')
