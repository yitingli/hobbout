...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserActivityBridge'
        db.create_table(u'activities_useractivitybridge', (
        ...
        db.send_create_signal(u'activities', ['UserActivityBridge'])

        # Deleting field 'Activity.participants'
        db.delete_column(u'activities_activity', 'participants')


    def backwards(self, orm):
        # Deleting model 'UserActivityBridge'
        db.delete_table(u'activities_useractivitybridge')

        # Adding field 'Activity.participants'
        db.add_column(u'activities_activity', 'participants',
                      self.gf('annoying.fields.JSONField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'activities.useractivitybridge': {
            'Meta': {'object_name': 'UserActivityBridge'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.Activity']"}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
