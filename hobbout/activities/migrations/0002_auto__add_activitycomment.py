...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activities_activitycomment', (
            ...
            ('parent_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivityComment'], null=True, blank=True)),
        ))
        db.send_create_signal(u'activities', ['ActivityComment'])


    def backwards(self, orm):
        # Deleting model 'ActivityComment'
        db.delete_table(u'activities_activitycomment')
    ...
    models = {
        u'activities.activity': {
            ...
            'pcount': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
