...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'activities_activity', (
            ...
            ('place', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('participants', self.gf('annoying.fields.JSONField')(null=True, blank=True)),
            ('pcount', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
