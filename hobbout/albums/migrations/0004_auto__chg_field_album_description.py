...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'albums_album', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Album.description'
        db.alter_column(u'albums_album', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
