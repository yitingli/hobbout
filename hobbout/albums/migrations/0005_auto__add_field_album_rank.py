...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.rank'
        db.add_column(u'albums_album', 'rank',
                      self.gf('django.db.models.fields.FloatField')(default=100.0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.rank'
        db.delete_column(u'albums_album', 'rank')
