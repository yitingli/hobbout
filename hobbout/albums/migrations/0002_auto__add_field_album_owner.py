...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.owner'
        db.add_column(u'albums_album', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.TingUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.owner'
        db.delete_column(u'albums_album', 'owner_id')
