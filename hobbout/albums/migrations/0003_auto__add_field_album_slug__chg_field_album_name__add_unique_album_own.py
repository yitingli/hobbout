...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'albums_album', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='slug-default', max_length=50),
                      keep_default=False)


        # Changing field 'Album.name'
        db.alter_column(u'albums_album', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Adding unique constraint on 'Album', fields ['owner', 'slug']
        db.create_unique(u'albums_album', ['owner_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Album', fields ['owner', 'slug']
        db.delete_unique(u'albums_album', ['owner_id', 'slug'])

        # Deleting field 'Album.slug'
        db.delete_column(u'albums_album', 'slug')


        # Changing field 'Album.name'
        db.alter_column(u'albums_album', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
