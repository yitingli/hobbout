...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TingUser.avatar'
        db.add_column(u'users_tinguser', 'avatar',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaImage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TingUser.avatar'
        db.delete_column(u'users_tinguser', 'avatar_id')
