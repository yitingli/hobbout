...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TingUser.brief_description'
        db.add_column(u'users_tinguser', 'brief_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=180, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TingUser.brief_description'
        db.delete_column(u'users_tinguser', 'brief_description')
