...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TingUser.birth_date'
        db.add_column(u'users_tinguser', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TingUser.birth_date'
        db.delete_column(u'users_tinguser', 'birth_date')
