...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TingUser.avatar'
        db.alter_column(u'users_tinguser', 'avatar_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaImage'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'TingUser.avatar'
        db.alter_column(u'users_tinguser', 'avatar_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaImage'], null=True))
