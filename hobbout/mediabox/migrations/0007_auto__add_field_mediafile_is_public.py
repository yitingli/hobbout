...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaFile.is_public'
        db.add_column(u'mediabox_mediafile', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaFile.is_public'
        db.delete_column(u'mediabox_mediafile', 'is_public')
