...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaVideo.video_code'
        db.alter_column(u'mediabox_mediavideo', 'video_code', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'MediaVideo.video_code'
        db.alter_column(u'mediabox_mediavideo', 'video_code', self.gf('django.db.models.fields.CharField')(max_length=300))
