...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaImage.image'
        db.alter_column(u'mediabox_mediaimage', 'image', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100))

    def backwards(self, orm):

        # Changing field 'MediaImage.image'
        db.alter_column(u'mediabox_mediaimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
