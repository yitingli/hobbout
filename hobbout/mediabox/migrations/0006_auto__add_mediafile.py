...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mediabox_mediafile', (
            ...
            ('title', self.gf('django.db.models.fields.CharField')(default='Untitled', max_length=50, blank=True)),
            ('doc', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('rank', self.gf('django.db.models.fields.FloatField')(default=100.0, blank=True)),
        ))
        db.send_create_signal(u'mediabox', ['MediaFile'])


    def backwards(self, orm):
        # Deleting model 'MediaFile'
        db.delete_table(u'mediabox_mediafile')
