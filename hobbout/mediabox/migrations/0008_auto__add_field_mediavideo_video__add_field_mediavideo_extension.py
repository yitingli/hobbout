...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaVideo.video'
        db.add_column(u'mediabox_mediavideo', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MediaVideo.extension'
        db.add_column(u'mediabox_mediavideo', 'extension',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaVideo.video'
        db.delete_column(u'mediabox_mediavideo', 'video')

        # Deleting field 'MediaVideo.extension'
        db.delete_column(u'mediabox_mediavideo', 'extension')
    ...
    models = {
        ...
        u'mediabox.mediafile': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "'Untitled'", 'max_length': '50', 'blank': 'True'})
        },
