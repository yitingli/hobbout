...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaImage.width'
        db.add_column(u'mediabox_mediaimage', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MediaImage.height'
        db.add_column(u'mediabox_mediaimage', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaImage.width'
        db.delete_column(u'mediabox_mediaimage', 'width')

        # Deleting field 'MediaImage.height'
        db.delete_column(u'mediabox_mediaimage', 'height')
